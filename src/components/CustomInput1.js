...
import { grey, amber, red, white } from '@mui/material/colors';
...
const CustomInput1 = (props) => {
  const {
    ...
    form: { errors, touched, setFieldTouched }, label, labD = 4, fieldD = 8, required = false, placeholder, numberOfLines = 3,
    ...inputProps
  } = props
...
{/*    <View style={styles.container}> */}
    ...
    <Grid container display="flex"     alignItems="center">
      ...
      <Grid xs={fieldD} sx={{backgroundColor:'white'}}>
      <TextField
        value={value}
        multiline
        rows={numberOfLines}
